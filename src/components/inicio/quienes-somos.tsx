    ...
    return (
        <div className="primary-color-background" style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ textAlign: 'center', backgroundColor: 'white', maxWidth: '1270px' }}>
            <div><img src={topImage} style={{ maxWidth: '100%' }} alt="" /></div>  
            ...
            <div className='primary-text'>Nuestros productos</div>
                ...
                <div className='flex justify-content-center flex-column gap-6'>
                    ...
                    <div className='grid gap-6 w-full align-items-center'>
                        <div className='w-full sm:w-7 lg:w-5'><img src={fruitsImage} style={{ width: '100%' }} alt="" /></div>
                    ...
                    <div className='grid gap-6 w-full align-items-center'>
                        ...
                        <div className='w-full sm:w-7 lg:w-5'><img src={vegetablesImage} style={{ width: '100%' }} alt="" /></div>
                    </div>
                    ...
                    <div className='grid gap-6 w-full align-items-center'>
                        <div className='w-full sm:w-7 lg:w-5'><img src={breadsImage} style={{ width: '100%' }} alt="" /></div>
                        <div className='flex flex-column w-full sm:w-4 lg:w-6 align-items-center justify-content-center box'>
                    ...
                    <div className='grid gap-6 w-full align-items-center'>
                        ...
                        <div className='w-full sm:w-7 lg:w-5'><img src={lacteosImage} style={{ width: '100%' }} alt="" /></div>
                    </div>

                    <hr className='separator'/>

                    <div className='grid gap-6 w-full align-items-center'>
                        <div className='w-full sm:w-7 lg:w-5'><img src={proteinasImage} style={{ width: '100%' }} alt="" /></div>
                        <div className='flex flex-column w-full sm:w-4 lg:w-6 align-items-center justify-content-center box'>
                    ...
                    <div className='grid gap-6 w-full align-items-center'>
                        ...
                        <div className='w-full sm:w-7 lg:w-5'><img src={bebidasImage} style={{ width: '100%' }} alt="" /></div>
                    </div>

                    <hr className='separator'/>

                    <div className='grid gap-6 w-full align-items-center'>
                        <div className='w-full sm:w-7 lg:w-5'><img src={granosImage} style={{ width: '100%' }} alt="" /></div>
                        <div className='flex flex-column w-full sm:w-4 lg:w-6 align-items-center justify-content-center box'>
